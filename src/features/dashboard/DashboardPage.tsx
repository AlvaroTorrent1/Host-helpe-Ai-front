    ...
    const fetchData = async () => {
      try {
        ...
        if (incidentsError) {
          ...
          // Mostrar solo incidencias reales desde la base de datos
          // Eliminamos cualquier lógica de generación/mezcla de datos mock o
          // enriquecimiento artificial para asegurar que la tabla refleje
          // exclusivamente información verídica de producción.
