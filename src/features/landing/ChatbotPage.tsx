            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  {t("chatbotPage.benefits.availability.title")}
                </h3>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  {t("chatbotPage.benefits.income.title")}
                </h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  {t("chatbotPage.benefits.experience.title")}
                </h3>
                <p className="text-gray-600">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">
                      {t("chatbotPage.features.sesAutomation.title")}
                    </h3>
                    <p className="mt-2 text-gray-600">
                      {t("chatbotPage.features.sesAutomation.description")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">
                      {t("chatbotPage.features.incidentResolution.title")}
                    </h3>
                    <p className="mt-2 text-gray-600">
                      {t("chatbotPage.features.incidentResolution.description")}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">
                      {t("chatbotPage.features.localRecommendations.title")}
                    </h3>
                    <p className="mt-2 text-gray-600">
                      {t(
                        "chatbotPage.features.localRecommendations.description",
                      )}
                    </p>
                  </div>
                </div>
                ...
                <div className="aspect-w-16 aspect-h-9 bg-white rounded-xl shadow-lg overflow-hidden">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src =
                        "https://via.placeholder.com/800x450?text=Características+del+Chatbot";
                    }}
                  />
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-xs text-gray-500">
                        {t("chatbotPage.features.conversionRate.title")}
                      </p>
                      <p className="text-xl font-bold text-gray-900">
                        {t("chatbotPage.features.conversionRate.value")}
                      </p>
                      <p className="text-xs text-gray-500">
                        {t("chatbotPage.features.conversionRate.description")}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="ml-3 text-gray-600">
                      {t("chatbotPage.demo.capabilities.instructions")}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span className="ml-3 text-gray-600">
                      {t("chatbotPage.demo.capabilities.technicalProblems")}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span className="ml-3 text-gray-600">
                      {t("chatbotPage.demo.capabilities.recommendations")}
                    </span>
                  </li>
                  <li className="flex items-start">
                    <svg
                    ...
                    <span className="ml-3 text-gray-600">
                      {t("chatbotPage.demo.capabilities.transportation")}
                    </span>
                  </li>
                </ul>
              </div>
                  ...
                  <div className="w-full h-full flex items-center justify-center bg-gray-100">
                    ...
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-500">
                        {t("chatbotPage.demo.videoPlaceholder")}
                      </p>
                    </div>
                  </div>
                </div>
