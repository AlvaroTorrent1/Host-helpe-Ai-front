...
const ChatbotPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        {/* Beneficios principales - Now as the first section */}
        <section className="py-20 bg-white">
          <div className="container-limited">
            <div className="text-center mb-16">
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">{t('chatbotPage.hero.title')}</h1>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{t('chatbotPage.hero.subtitle')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('chatbotPage.benefits.availability.title')}</h3>
                <p className="text-gray-600">
                  {t('chatbotPage.benefits.availability.description')}
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('chatbotPage.benefits.income.title')}</h3>
                <p className="text-gray-600">
                  {t('chatbotPage.benefits.income.description')}
                </p>
              </div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('chatbotPage.benefits.experience.title')}</h3>
                <p className="text-gray-600">
                  {t('chatbotPage.benefits.experience.description')}
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-limited">
            <div className="text-center mb-16">
              <span className="inline-block px-4 py-1 bg-primary-100 text-primary-600 rounded-full text-sm font-medium mb-4">{t('chatbotPage.features.subtitle')}</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{t('chatbotPage.features.title')}</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                {t('chatbotPage.features.description')}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('chatbotPage.features.multilingual.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('chatbotPage.features.multilingual.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('chatbotPage.features.sesAutomation.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('chatbotPage.features.sesAutomation.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('chatbotPage.features.incidentResolution.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('chatbotPage.features.incidentResolution.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('chatbotPage.features.localRecommendations.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('chatbotPage.features.localRecommendations.description')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-w-16 aspect-h-9 bg-white rounded-xl shadow-lg overflow-hidden">
                  ...
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://via.placeholder.com/800x450?text=Características+del+Chatbot';
                    }}
                  />
                </div>
                ...
                <div className="absolute -bottom-8 -right-8 bg-white rounded-lg shadow-xl p-4 w-64 transform rotate-3 animate-float" style={{ animationDuration: '5s' }}>
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-xs text-gray-500">{t('chatbotPage.features.conversionRate.title')}</p>
                      <p className="text-xl font-bold text-gray-900">{t('chatbotPage.features.conversionRate.value')}</p>
                      <p className="text-xs text-gray-500">{t('chatbotPage.features.conversionRate.description')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container-limited">
            <div className="flex flex-col lg:flex-row items-center">
              <div className="lg:w-1/2 mb-10 lg:mb-0">
                <span className="inline-block px-4 py-1 bg-primary-100 text-primary-600 rounded-full text-sm font-medium mb-4">{t('chatbotPage.demo.subtitle')}</span>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">{t('chatbotPage.demo.title')}</h2>
                <p className="text-lg text-gray-600 mb-8">
                  {t('chatbotPage.demo.description')}
                </p>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('chatbotPage.demo.capabilities.instructions')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('chatbotPage.demo.capabilities.technicalProblems')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('chatbotPage.demo.capabilities.recommendations')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('chatbotPage.demo.capabilities.transportation')}</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="aspect-w-16 aspect-h-9 bg-gray-100 rounded-xl shadow-lg overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center bg-gray-100">
                    ...
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-500">{t('chatbotPage.demo.videoPlaceholder')}</p>
                    </div>
                  </div>
                </div>
              </div>
