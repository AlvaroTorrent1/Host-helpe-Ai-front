    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section className="py-20 bg-white">
          <div className="container-limited">
            <div className="text-center mb-16">
              <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-6">{t('checkinPage.hero.title')}</h1>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{t('checkinPage.hero.subtitle')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('checkinPage.benefits.compliance.title')}</h3>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('checkinPage.benefits.timeSaving.title')}</h3>
                <p className="text-gray-600">
              ...
              <div className="bg-white rounded-xl shadow-lg p-8 transform hover:-translate-y-2 transition-all duration-300 group hover:shadow-xl">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{t('checkinPage.benefits.experience.title')}</h3>
                <p className="text-gray-600">
        ...
        <section className="py-20 bg-gray-50">
          <div className="container-limited">
            <div className="text-center mb-16">
              <span className="inline-block px-4 py-1 bg-primary-100 text-primary-600 rounded-full text-sm font-medium mb-4">{t('checkinPage.features.subtitle')}</span>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">{t('checkinPage.features.title')}</h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('checkinPage.features.sesIntegration.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('checkinPage.features.sesIntegration.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('checkinPage.features.customForms.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('checkinPage.features.customForms.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('checkinPage.features.documentCapture.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('checkinPage.features.documentCapture.description')}</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-gray-900">{t('checkinPage.features.reservationManagement.title')}</h3>
                    <p className="mt-2 text-gray-600">{t('checkinPage.features.reservationManagement.description')}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="aspect-w-16 aspect-h-9 bg-white rounded-xl shadow-lg overflow-hidden">
                  ...
                  <img 
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://via.placeholder.com/800x450?text=Check-in+Automatizado';
                    }}
                  />
                </div>
                ...
                <div className="absolute -bottom-8 -right-8 bg-white rounded-lg shadow-xl p-4 w-64 transform rotate-3 animate-float" style={{ animationDuration: '5s' }}>
                  <div className="flex items-center">
                    ...
                    <div className="ml-4">
                      <p className="text-xs text-gray-500">{t('checkinPage.features.registrationTime.title')}</p>
                      <p className="text-xl font-bold text-gray-900">{t('checkinPage.features.registrationTime.value')}</p>
                      <p className="text-xs text-gray-500">{t('checkinPage.features.registrationTime.description')}</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="container-limited">
            <div className="flex flex-col lg:flex-row items-center">
              <div className="lg:w-1/2 mb-10 lg:mb-0">
                <span className="inline-block px-4 py-1 bg-primary-100 text-primary-600 rounded-full text-sm font-medium mb-4">{t('checkinPage.demo.subtitle')}</span>
                <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">{t('checkinPage.demo.title')}</h2>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <span className="ml-3 text-gray-600">{t('checkinPage.demo.capabilities.dataCollection')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('checkinPage.demo.capabilities.links')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('checkinPage.demo.capabilities.validation')}</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="w-6 h-6 text-primary-500 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span className="ml-3 text-gray-600">{t('checkinPage.demo.capabilities.transmission')}</span>
                  </li>
                </ul>
              </div>
                ...
                <div className="aspect-w-16 aspect-h-9 bg-gray-100 rounded-xl shadow-lg overflow-hidden">
                  <div className="w-full h-full flex items-center justify-center bg-gray-100">
                    ...
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-500">{t('checkinPage.demo.videoPlaceholder')}</p>
                    </div>
                  </div>
                </div>
              </div>
