...
const PropertyImagesForm: React.FC<PropertyImagesFormProps> = ({ images = [], onChange }) => {
  ...
  return (
    <div className="space-y-4">
      <div className="border-b border-gray-200 pb-2">
        <h3 className="text-lg font-medium text-gray-900">Imágenes adicionales</h3>
        <p className="mt-1 text-sm text-gray-500">
          Añade imágenes con descripción para mostrar al turista información visual sobre la propiedad. 
          Las imágenes deben ir acompañadas de un contexto claro para que nuestro agente de IA sepa 
          cuándo mostrarlas al turista (por ejemplo, "Vista desde la terraza" o "Instrucciones del horno").
        </p>
      </div>
