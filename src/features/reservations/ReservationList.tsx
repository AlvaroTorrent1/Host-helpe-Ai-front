  ...
  useEffect(() => {
    const filtered = reservations.filter(reservation => {
      ...
      if (filters.searchTerm) {
        ...
        const fullName = `${mainGuest.firstName} ${mainGuest.lastName}`.toLowerCase();
    ...
    <div className="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center">
          <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4 sm:mb-0">Reservas</h3>
          <button
            type="button"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => handleFilterChange({ status: e.target.value as ReservationStatus | 'all' })}
              className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
            >
          ...
          {/* Filtro de propiedad */}
          <div>
            <label htmlFor="property" className="block text-sm font-medium text-gray-700">Propiedad</label>
            <select
              id="property"
              name="property"
      ...
      {filteredReservations.length === 0 ? (
        <div className="text-center p-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            {Object.values(filters).some(val => val !== undefined && val !== '' && val !== 'all')
