...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gray-50 text-gray-700 py-8 w-full relative overflow-hidden border-t border-gray-200">
      ...
      <div className="container-limited relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center">
          {/* Footer reorganizado: Contacto (izq) - Síguenos (centro) - Con el apoyo de (der) */}
          {/* Contacto - Left */}
          <div className="flex flex-col items-center md:items-start lg:items-start">
            <h4 className="text-lg font-medium mb-3 relative inline-block">
              {t("footer.contact")}
              <span className="absolute -bottom-1 left-1/2 md:left-0 lg:left-0 transform -translate-x-1/2 md:translate-x-0 lg:translate-x-0 w-10 h-0.5 bg-primary-400"></span>
            </h4>
            <div className="flex flex-col items-center md:items-start space-y-2">
              <a
                href="mailto:support@hosthelperai.com"
                className="group flex items-center justify-center md:justify-start text-gray-600 hover:text-primary-600 transition-all duration-300"
              >
          ...
          <div className="flex flex-col items-center md:items-end lg:items-end">
            <h4 className="text-lg font-medium mb-3 relative inline-block">
              {t("footer.support")}
              <span className="absolute -bottom-1 left-1/2 md:right-0 lg:right-0 transform -translate-x-1/2 md:translate-x-0 lg:translate-x-0 w-10 h-0.5 bg-primary-400"></span>
            </h4>
        ...
        <div className="mt-8 pt-6 border-t border-gray-200/50 text-center">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-2 mb-2">
            <Link
              to="/privacy-policy"
              className="text-gray-600 hover:text-primary-600 text-sm font-medium transition-all duration-300"
            >
            ...
            <Link
              to="/data-deletion"
              className="text-gray-600 hover:text-red-600 text-sm font-medium transition-all duration-300"
            >
