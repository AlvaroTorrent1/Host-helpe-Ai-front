      ...
      <li className="pt-2 border-t border-gray-200">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className={`flex items-center space-x-1 ${language === 'es' ? 'text-gray-800 font-medium' : 'text-gray-600'} hover:text-primary-500`}
          >
            <span>ES</span>
          </button>
          <button
            onClick={() => handleLanguageChange('en')}
            className={`flex items-center space-x-1 ${language === 'en' ? 'text-gray-800 font-medium' : 'text-gray-600'} hover:text-primary-500`}
          >
            <span>EN</span>
          </button>
        </div>
