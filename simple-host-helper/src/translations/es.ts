...
export const es = {
  ...
  pricing: {
    ...
    faq: {
      ...
      a1: 'El soporte prioritario incluye atención telefónica en horario extendido, tiempo de respuesta garantizado inferior a 2 horas y un gestor de cuenta dedicado.',
      q2: '¿Puedo cambiar de plan posteriormente?',
      a2: 'Sí, puedes actualizar o cambiar tu plan en cualquier momento de forma proporcional.',
