        ...
        <section id="features" className="py-12 md:py-20 bg-white w-full">
          <div className="container-limited">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              <div className="bg-gray-50 p-6 md:p-8 rounded-lg border border-gray-100 hover:border-amber-300 transition-all duration-300 hover:shadow-lg group relative overflow-hidden">
                <div className="absolute -right-12 -top-12 w-24 h-24 bg-amber-100 rounded-full opacity-0 group-hover:opacity-30 transform scale-0 group-hover:scale-100 transition-all duration-500"></div>
                <div className="w-20 h-20 bg-amber-100 rounded-full flex items-center justify-center mb-6 transform group-hover:scale-110 group-hover:bg-amber-200 transition-all duration-300 relative">
                  <svg className="w-10 h-10 text-amber-500 group-hover:text-amber-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 20 20">
